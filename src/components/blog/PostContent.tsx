  ...
  return (
    <EditorContent
      ...
      className={cn(
        ...
        "[&_h2]:mb-5 [&_h2]:mt-12 [&_h2]:font-mono [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:leading-[1.2] [&_h2]:text-[#121F38]",
        "[&_h3]:mb-4 [&_h3]:mt-10 [&_h3]:font-mono [&_h3]:text-2xl [&_h3]:font-semibold [&_h3]:leading-[1.3] [&_h3]:text-[#121F38]",
        "[&_hr]:border-[#C4CAD6]",
